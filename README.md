...
- Multiple unit types: Infantry, Archer, Priest, Engineer, Cannon
- Special fields: Fortress, Mana Mine, Trap, Hospital, Hill, Burned, Shielded
- Spells: Morog, Fireball, Curse, Bomb, Teleport
- Resource management (mana)
- Victory by eliminating the opponent or capturing all fortresses

## How to Play
1. Build the game with `make`.
